...
@Component({
  selector: 'app-add-agreement-file-form',
  standalone: false,
  templateUrl: './add-agreement-file-form.component.html',
  styleUrl: './add-agreement-file-form.component.scss',
})
export class AddAgreementFileFormComponent implements OnInit, OnDestroy {
  ...
  @Input() addAgreementsForm!: boolean;
  ...
  @Input() addAgreementFileForm!: boolean;
  ...
  viewAgreements() {
    this.router.navigate(['/purchasing/agreements/view-agreements']);
  }
  viewAgreementFiles() {
    this.router.navigate([
      `/purchasing/agreements/activities/view-agreement-files/${this.mandateStatusIdParam}`,
    ]);
  }

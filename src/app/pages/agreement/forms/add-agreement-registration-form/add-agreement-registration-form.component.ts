...
@Component({
  selector: 'app-add-agreement-registration-form',
  standalone: false,
  templateUrl: './add-agreement-registration-form.component.html',
  styleUrl: './add-agreement-registration-form.component.scss',
})
export class AddAgreementRegistrationFormComponent
  implements OnInit, OnDestroy
{
  ...
  @Input() addAgreementRegistrationsForm!: boolean;
  ...
  viewAgreementRegistrationsDetails() {
    this.router.navigate([
      `/agreement/activities/wizard-agreement/view-agreement-registrations/${this.clientStatusIdParam}`,
    ]);
  }

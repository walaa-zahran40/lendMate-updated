...
@Component({
  selector: 'app-agreement-main-information-form',
  standalone: false,
  templateUrl: './agreement-main-information-form.component.html',
  styleUrl: './agreement-main-information-form.component.scss',
})
export class AgreementMainInformationFormComponent

...
@Component({
  selector: 'app-leasing-financial-currency-form',
  standalone: false,
  templateUrl: './leasing-financial-currency-form.component.html',
  styleUrl: './leasing-financial-currency-form.component.scss',
})
export class LeasingFinancialCurrencyFormComponent

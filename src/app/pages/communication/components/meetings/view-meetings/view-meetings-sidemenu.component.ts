...
@Component({
  selector: 'app-view-meetings-sidemenu',
  standalone: false,
  templateUrl: './view-meetings-sidemenu.component.html',
  styleUrl: './view-meetings-sidemenu.component.scss',
})
export class ViewMeetingsSideMenuComponent {

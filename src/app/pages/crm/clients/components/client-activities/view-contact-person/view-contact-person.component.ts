  ...
  .subscribe((result) => {
    ...
    onAddClientContactPerson() {
     ...
     const routeId=this.route.snapshot.paramMap.get('clientId')
      this.router.navigate(
        ['crm/clients/add-contact-person', routeId],
        {
          queryParams: {
            mode: 'add',
    ...
    confirmDelete() {
      if (this.selectedClientContactPersonId != null) {
        this.facade.delete(this.selectedClientContactPersonId, this.clientIdParam);
      }
    ...
    onSearch(keyword: string) {
      ...
      this.filteredClientContactPersons = this.originalClientContactPersons.filter(
        (clientSales) =>
    ...
    onEditClientContactPerson(clientSales: ClientContactPerson) {
      console.log('edioyt', this.clientIdParam);
      this.router.navigate(
        ['/crm/clients/add-contact-person', clientSales.id],
        {
          queryParams: {
            mode: 'edit',

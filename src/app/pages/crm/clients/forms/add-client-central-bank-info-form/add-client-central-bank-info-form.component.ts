...
@Component({
  selector: 'app-add-client-central-bank-info-form',
  standalone: false,
  templateUrl: './add-client-central-bank-info-form.component.html',
  styleUrl: './add-client-central-bank-info-form.component.scss',
})
export class AddClientCentralBankInfoFormComponent

...
@Component({
  selector: 'app-add-client-cr-authority-offices-form',
  standalone: false,
  templateUrl: './add-client-cr-authority-offices-form.component.html',
  styleUrl: './add-client-cr-authority-offices-form.component.scss',
})
export class AddClientCrAuthorityOfficesFormComponent

...
@Component({
  selector: 'app-add-client-guarantors-form',
  standalone: false,
  templateUrl: './add-client-guarantors-form.component.html',
  styleUrl: './add-client-guarantors-form.component.scss',
})
export class AddClientGuarantorsFormComponent implements OnInit, OnDestroy {

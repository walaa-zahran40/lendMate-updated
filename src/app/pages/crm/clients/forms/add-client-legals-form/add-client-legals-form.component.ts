...
@Component({
  selector: 'app-add-client-legals-form',
  standalone: false,
  templateUrl: './add-client-legals-form.component.html',
  styleUrl: './add-client-legals-form.component.scss',
})
export class AddClientLegalsFormComponent implements OnInit, OnDestroy {

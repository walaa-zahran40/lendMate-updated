...
@Component({
  selector: 'app-add-client-onboarding-form',
  standalone: false,
  templateUrl: './add-client-onboarding-form.component.html',
  styleUrl: './add-client-onboarding-form.component.scss',
})
export class AddClientOnboardingFormComponent implements OnInit, OnDestroy {

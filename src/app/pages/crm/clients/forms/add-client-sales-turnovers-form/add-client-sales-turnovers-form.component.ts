...
@Component({
  selector: 'app-add-client-sales-turnovers-form',
  standalone: false,
  templateUrl: './add-client-sales-turnovers-form.component.html',
  styleUrl: './add-client-sales-turnovers-form.component.scss',
})
export class AddClientSalesTurnoversFormComponent implements OnInit, OnDestroy {

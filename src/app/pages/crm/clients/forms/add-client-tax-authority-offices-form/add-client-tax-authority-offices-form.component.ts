...
@Component({
  selector: 'app-add-client-tax-authority-offices-form',
  standalone: false,
  templateUrl: './add-client-tax-authority-offices-form.component.html',
  styleUrl: './add-client-tax-authority-offices-form.component.scss',
})
export class AddClientTaxAuthorityOfficesFormComponent

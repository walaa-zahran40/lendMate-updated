...
@Component({
  selector: 'app-add-client-upload-documents-form',
  standalone: false,
  templateUrl: './add-client-upload-documents-form.component.html',
  styleUrl: './add-client-upload-documents-form.component.scss',
})
export class AddClientUploadDocumentsFormComponent

...
import { MandatePaymentSettingsService } from './mandate-payment-settings.service';
import * as ActionsList from './mandate-payment-settings.actions';
import { catchError, map, mergeMap, of, tap } from 'rxjs';
import { MandatePaymentSetting } from './mandate-payment-setting.model';
import { EntityNames } from '../../../../../shared/constants/entity-names';

@Injectable()
export class MandatePaymentSettingsEffects {
  constructor(
    private actions$: Actions,
    private service: MandatePaymentSettingsService
  ) {}
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ payload }) => {
        const dto = payload as Omit<MandatePaymentSetting, 'id'>;
        return this.service.create(dto).pipe(
          mergeMap((entity) => [
            ActionsList.createEntitySuccess({ entity }),
            ActionsList.entityOperationSuccess({
              entity: EntityNames.MandatePaymentSetting,
              operation: 'create',
            }),
          ]),

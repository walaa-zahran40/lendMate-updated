...
export class ViewClientStatusActionsComponent {
  ...
  constructor(private router: Router, private facade: ClientStatusActionsFacade,private store: Store
  ) {}
  ngOnInit() {
    this.facade.loadAll();
  ...
  onSearch(keyword: string) {
    ...
    this.filteredClientStatusActions = this.originalClientStatusActions.filter((clientStatusAction) =>
  ...
  onEditClientStatusAction(clientStatusAction: ClientStatusAction) {
    this.router.navigate(['/lookups/edit-client-status-actions', clientStatusAction.id], {

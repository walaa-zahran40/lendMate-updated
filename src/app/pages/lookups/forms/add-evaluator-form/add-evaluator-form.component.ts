...
@Component({
  selector: 'app-add-evaluator-form',
  standalone: false,
  templateUrl: './add-evaluator-form.component.html',
  styleUrl: './add-evaluator-form.component.scss',
})
export class AddEvaluatorFormComponent implements OnInit, OnDestroy {
  ...
  @Input() addEvaluatorsLookupsForm!: boolean;

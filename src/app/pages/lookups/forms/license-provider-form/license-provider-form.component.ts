...
@Component({
  selector: 'app-license-provider-form',
  standalone: false,
  templateUrl: './license-provider-form.component.html',
  styleUrl: './license-provider-form.component.scss',
})
export class LicenseProviderFormComponent implements OnInit, OnDestroy {
  ...
  @Input() addLicenseProvidersLookupsForm!: boolean;

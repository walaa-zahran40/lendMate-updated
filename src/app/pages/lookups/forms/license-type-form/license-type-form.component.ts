...
@Component({
  selector: 'app-license-type-form',
  standalone: false,
  templateUrl: './license-type-form.component.html',
  styleUrl: './license-type-form.component.scss',
})
export class LicenseTypeFormComponent implements OnInit, OnDestroy {

...
@Component({
  selector: 'app-vehicle-manufacturer-form',
  standalone: false,
  templateUrl: './vehicle-manufacturer-form.component.html',
  styleUrl: './vehicle-manufacturer-form.component.scss',
})
export class VehicleManufacturerFormComponent implements OnInit, OnDestroy {
  ...
  @Input() addVehicleManufacturersLookupsForm!: boolean;

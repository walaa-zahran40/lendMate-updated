...
@Component({
  selector: 'app-vendor-address-form',
  standalone: false,
  templateUrl: './vendor-address-form.component.html',
  styleUrl: './vendor-address-form.component.scss',
})
export class VendorAddressFormComponent implements OnInit, OnDestroy {
  ...
  optionLabelKey = 'name';
  filterByField = 'name';
  @Input() addVendorAddressesLookupsForm!: boolean;
  ...
  @Input() addLicenseTypesLookupsForm!: boolean;

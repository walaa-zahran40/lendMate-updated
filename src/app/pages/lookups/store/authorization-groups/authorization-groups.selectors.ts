...
export const selectFeature = createFeatureSelector<State>('authorizationGroups');
export const selectAuthorizationGroupsFeature =
  createFeatureSelector<State>('authorizationGroups');

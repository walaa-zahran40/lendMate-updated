...
import * as ClientStatusActionActions from './client-status-actions.actions';
import { adapter, initialState } from './client-status-actions.state';
...
export const reducer = createReducer(
  ...
  //History management
  on(ClientStatusActionActions.loadClientStatusActionHistory, (state) => ({
    ...state,
    historyLoaded: false,
    historyError: null,
  })),
  ...
  on(
    ClientStatusActionActions.loadClientStatusActionHistorySuccess,
    (state, { history }) => ({
      ...state,
      history,
      historyLoaded: true,

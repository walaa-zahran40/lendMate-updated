...
import { ClientStatusActionsService } from './client-statuses-actions.service';
import * as ActionsList from './client-statuses-actions.actions';
import { catchError, map, mergeMap, of, tap } from 'rxjs';
import { ClientStatusAction } from './client-statuses-action.model';
import { EntityNames } from '../../../../shared/constants/entity-names';

@Injectable()
export class ClientStatusActionsEffects {
  constructor(private actions$: Actions, private svc: ClientStatusActionsService) {}
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ payload }) => {
        const dto = payload as Omit<ClientStatusAction, 'id'>;
        return this.svc.create(dto).pipe(
          mergeMap((entity) => [
            ActionsList.createEntitySuccess({ entity }),
            ActionsList.entityOperationSuccess({
              entity: EntityNames.ClientStatusAction,
              operation: 'create',
            }),
          ]),

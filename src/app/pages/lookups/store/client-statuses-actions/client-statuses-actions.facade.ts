...
import * as Actions from './client-statuses-actions.actions';
import * as Selectors from './client-statuses-actions.selectors';
...
export class ClientStatusActionsFacade {
  ...
  totalCount$ = this.store.select(Selectors.selectClientStatusActionsTotalCount);

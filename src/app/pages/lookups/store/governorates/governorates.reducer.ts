...
export const reducer = createReducer(
  ...
  on(GovernorateActions.loadGovernorateHistory, (state) => ({
    ...state,
    historyLoaded: false,
    historyError: null,
  })),
  ...
  on(
    GovernorateActions.loadGovernorateHistorySuccess,
    (state, { history }) => ({
      ...state,
      history,
      historyLoaded: true,
  ...
  on(GovernorateActions.loadGovernorateHistorySuccess, (state, { history }) => {

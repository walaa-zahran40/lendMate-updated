...
@Component({
  selector: 'app-form-signatory-officer',
  standalone: false,
  templateUrl: './form-signatory-officer.component.html',
  styleUrl: './form-signatory-officer.component.scss',
})
export class FormSignatoryOfficerComponent {

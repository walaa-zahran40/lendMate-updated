...
import * as ActionsList from './operations.actions';
...
export class OperationsEffects {
  constructor(private actions$: Actions, private service: OperationsService) {}
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.service.getAll().pipe(
          ...
          catchError((err) => {
            console.error('⚠️ Error loading operations', err);
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ payload }) => {
        const dto = payload as Omit<Operation, 'id'>;
        return this.service.create(dto).pipe(
          mergeMap((entity) => [
            ActionsList.createEntitySuccess({ entity }),
            ActionsList.entityOperationSuccess({
              entity: EntityNames.Operation,
              operation: 'create',
            }),
          ]),

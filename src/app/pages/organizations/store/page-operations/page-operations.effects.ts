...
import * as ActionsList from './page-operations.actions';
import { catchError, map, mergeMap, of, tap } from 'rxjs';
import { PageOperation } from './page-operation.model';
import { EntityNames } from '../../../../shared/constants/entity-names';

@Injectable()
export class PageOperationsEffects {
  constructor(
    private actions$: Actions,
    private service: PageOperationsService
  ) {}
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.service.getAll().pipe(
          ...
          catchError((err) => {
            console.error('⚠️ Error loading pageOperations', err);
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(({ payload }) => {
        const dto = payload as Omit<PageOperation, 'id'>;
        return this.service.create(dto).pipe(
          mergeMap((entity) => [
            ActionsList.createEntitySuccess({ entity }),
            ActionsList.entityPageOperationSuccess({
              entity: EntityNames.PageOperation,

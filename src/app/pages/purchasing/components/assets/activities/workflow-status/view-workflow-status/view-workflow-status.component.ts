...
@Component({
  selector: 'app-view-workflow-status',
  standalone: false,
  templateUrl: './view-workflow-status.component.html',
  styleUrl: './view-workflow-status.component.scss',
})
export class ViewWorkflowStatusComponent {

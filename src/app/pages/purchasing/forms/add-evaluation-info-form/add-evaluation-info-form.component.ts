...
@Component({
  selector: 'app-add-evaluation-info-form',
  standalone: false,
  templateUrl: './add-evaluation-info-form.component.html',
  styleUrl: './add-evaluation-info-form.component.scss',
})
export class AddEvaluationInfoFormComponent implements OnInit, OnDestroy {
  ...
  @Input() addEvaluationInformationForm!: boolean;
  ...
  @Input() addEvaluationInfoForm!: boolean;
  ...
  viewEvaluationInformationDetails() {
    this.router.navigate([
      '/purchasing/assets/activities/view-evaluation-information',

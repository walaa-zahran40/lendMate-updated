...
@Component({
  ...
  standalone: false,
  templateUrl: './add-purchasing-order-file-form.component.html',
  styleUrl: './add-purchasing-order-file-form.component.scss',
})
export class AddPurchasingOrderFileComponent implements OnInit, OnDestroy {
  ...
  @Input() addPurchasingOrderFileForm!: boolean;
